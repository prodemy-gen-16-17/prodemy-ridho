    ...
    const onSubmitForm = (data) => {
        if (dataCheckout && dataCheckout.id) {
            ...
            const payload = {
                ...
                priceTotal: dataCheckout.price * dataCheckout.qty,
                metodePembayaran: data.metodePembayaran,
                pilihanSesuai: data.pilihanSesuai
            };

            try {
                const response = axios.post("http://localhost:3000/bookings", payload);
    ...
    return (
        <section className='flex'>
            ...
            <div className="w-1/2 p-8 bg-[#b88967] rounded-md border border-amber-800">
                ...
                <div className="flex justify-between mb-4">
                    <span>Total:</span>
                    <span>{dataCheckout.price * dataCheckout.qty} KR</span>
                </div>
            </div>
        </section>
    );
